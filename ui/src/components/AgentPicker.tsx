          ...
          {!agents || agents.length === 0 ? (
            <div className="text-center py-8 text-slate-500">
              ...
              <p className="text-xs mb-4">
                Make sure a runtime is connected to the hub.
              </p>
              <button
                onClick={handleRefresh}
                ...
                return (
                  <button
                    ...
                    title={
                      usable
                        ? undefined
                        : unavailableReason || "Agent unavailable"
                    }
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 font-medium text-slate-100">
                          ...
                          <span
                            className={`inline-block w-2 h-2 rounded-full ${
                              usable ? "bg-green-400" : "bg-red-400"
                            }`}
                            title={
                              usable ? "Online" : unavailableReason || "Offline"
                            }
                          />
                        ...
                        <div className="text-xs text-slate-400 mt-0.5">
                          {usable
                            ? `${profile.label} · ${ep.id.slice(0, 12)}`
                            : unavailableReason ||
                      ...
                      {creating === ep.id && (
                        <svg
                          className="w-5 h-5 animate-spin text-teal-400 flex-shrink-0"
                          fill="none"
                          viewBox="0 0 24 24"
                        >
                          <circle
